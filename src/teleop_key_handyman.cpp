...
#include <sigverse_hsrb_utils/HandymanMsg.h>
...
public:
  ...
  void messageCallback(const sigverse_hsrb_utils::HandymanMsg::ConstPtr& message);
...
void HandymanTeleopKey::messageCallback(const sigverse_hsrb_utils::HandymanMsg::ConstPtr& message)
{
...
void HandymanTeleopKey::sendMessage(const std::string &message)
{
  ...
  sigverse_hsrb_utils::HandymanMsg handyman_msg;
...
int HandymanTeleopKey::run(int argc, char **argv)
{
  ...
  sub_msg_                = node_handle_.subscribe<sigverse_hsrb_utils::HandymanMsg>(sub_msg_to_robot_topic_name, 100, &HandymanTeleopKey::messageCallback, this);
  pub_msg_                = node_handle_.advertise<sigverse_hsrb_utils::HandymanMsg>(pub_msg_to_moderator_topic_name, 10);
